<x-layout>
    <div class="container tw-my-10">
        ...
        <div class="tw-max-w-4xl tw-mx-auto tw-mt-10 tw-bg-white tw-rounded-lg tw-shadow-md tw-p-6" data-aos="fade">
            ...
            <!-- Vendor Profile Form -->
            <form action="{{ route('update.profile', $profile->id) }}" method="POST" id="vendorProfileForm" class="tw-mt-6">
                @csrf
                <!-- Vendor Name -->
                <div class="tw-mb-4">
                    <label for="vendorName" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Vendor Name</label>
                    <input type="text" id="vendorName" name="name" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" value="{{ $supplier->name }}" required>
                </div>

                <!-- Contact Person -->
                <div class="tw-mb-4">
                    <label for="contactPerson" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Contact Person</label>
                    <input type="text" id="contactPerson" name="contact_person" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter contact person's name" required>
                </div>

                <!-- Contact Email -->
                <div class="tw-mb-4">
                    <label for="contactEmail" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Contact Email</label>
                    <input type="email" id="contactEmail" name="contact_email" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" value="{{ $supplier->email }}" required>
                </div>

                <!-- Contact Phone Number -->
                <div class="tw-mb-4">
                    <label for="contactPhone" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Contact Phone</label>
                    <input type="tel" id="contactPhone" name="contact_phone" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter contact phone number" required>
                </div>

                <!-- Business Address -->
                <div class="tw-mb-4">
                    <label for="businessAddress" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Business Address</label>
                    <input type="text" id="businessAddress" name="business_address" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter business address" required>
                </div>
