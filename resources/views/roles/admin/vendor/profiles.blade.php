        ...
        <div class="tw-max-w-7xl tw-mx-auto tw-mt-10 tw-bg-white tw-rounded-lg tw-shadow-lg tw-p-8" data-aos="fade">
            ...
            <div class="card-body">
                        ...
                        <tbody id="reservationRecords" class="tw-bg-white">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('view-profiles', $suppliers->user_id) }}" class="tw-text-blue-500 tw-underline">View</a>
                                    @else
                ...
                <div class="tw-mt-6" data-aos="fade-up">
                    <h3 class="tw-text-xl tw-font-semibold tw-text-gray-700 tw-mt-8 tw-mb-4">Explore Vendor Profiles and Assess Performance Metrics</h3>
                    <div class="tw-text-sm tw-text-gray-600 tw-mb-4">
                        <p>Use this section to review detailed profiles and performance metrics of your vendors. Gaining insights into each vendor’s history and performance will support you in making well-informed project assignments.</p>
                        <br>
