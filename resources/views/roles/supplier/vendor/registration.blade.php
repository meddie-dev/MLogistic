<x-layout>
    <div class="container-fluid px-4  tw-my-10">
        ...
        <div class="tw-max-w-7xl tw-mx-auto tw-mt-10 tw-bg-white tw-rounded-lg tw-shadow-md tw-p-6" data-aos="fade">
            <h2 class="tw-text-2xl tw-font-bold tw-text-gray-800 tw-text-center">Vendor Registration</h2>

            <!-- Vendor Registration Form -->
            <form action="{{ route('upload.registration', $supplier->id) }}" method="POST" enctype="multipart/form-data" id="vendorRegistrationForm" class="tw-mt-6">
                @csrf

                <!-- Company Details -->
                <div class="tw-mb-4">
                    <label for="company_name" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Company Name</label>
                    <input type="text" id="company_name" name="company_name" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter company name" required>
                    @error('company_name')
                ...
                <div class="tw-mb-4">
                    ...
                    <input type="text" id="company_address" name="company_address" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter company address" required>
                ...
                <div class="tw-mb-4">
                    ...
                    <input type="email" id="company_email" name="company_email" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Enter Email address" required>
                    @error('company_email')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                ...
                <div class="tw-mb-4">
                    ...
                    <textarea id="service_offerings" name="service_offerings" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="Describe the services or goods provided" rows="4" required></textarea>
                ...
                <div class="tw-mb-4">
                    ...
                    <textarea id="key_contacts" name="key_contacts" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-focus:ring-indigo-500 tw-focus:border-indigo-500" placeholder="List the main points of contact (names, roles, contact info)" rows="3" required></textarea>
                    @error('key_contacts')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror 
                </div>
                ...
                <div class="tw-mb-4">
                    ...
                    <p class="tw-text-xs tw-text-gray-500 tw-mb-1">Upload business registration certificates, proof of insurance, etc.</p>
                    <div class="tw-mt-1 tw-flex tw-justify-center tw-p-2 tw-border tw-border-gray-300 tw-rounded-md">
                        <input type="file" id="supporting_documents_path" name="supporting_documents_path" class="tw-block tw-w-full" accept=".pdf,.doc,.docx,.png,.jpg,.jpeg" required>
                    </div>
